...
export const validateMyRestaurantRequest=[
   ...
   body("deliveryPrice").isFloat({min:0}).withMessage("Delivery price must be a positive integer"),
   ...
   body("cuisines.*.name").notEmpty().withMessage("Menu item name is required"),
